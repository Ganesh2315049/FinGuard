...
public class Transaction {
    ...
    public UUID getId(){return id;} public User getUser(){return user;} public Account getSourceAccount(){return sourceAccount;} public Account getDestinationAccount(){return destinationAccount;} public BigDecimal getAmount(){return amount;} public Instant getCreatedAt(){return createdAt;} public TransactionType getType(){return type;} public TransactionStatus getStatus(){return status;} public String getTransactionReference(){return transactionReference;} public String getDescription(){return description;} public String getLocation(){return location;} public void setUser(User v){user=v;} public void setSourceAccount(Account v){sourceAccount=v;} public void setDestinationAccount(Account v){destinationAccount=v;} public void setType(TransactionType v){type=v;} public void setAmount(BigDecimal v){amount=v;} public void setStatus(TransactionStatus v){status=v;} public void setTransactionReference(String v){transactionReference=v;} public void setDescription(String v){description=v;} public void setLocation(String v){location=v;}
}
