...
public class RiskEvaluation {
    ...
    public void setTransaction(Transaction v){transaction=v;} public void setScore(int v){score=v;} public void setDecision(RiskDecision v){decision=v;} public void setReasons(String v){reasons=v;}
}
