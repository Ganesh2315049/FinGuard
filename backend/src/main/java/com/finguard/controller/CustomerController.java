...
public class CustomerController {
    ...
    public CustomerController(UserService users, AccountRepository accounts, TransactionRepository transactions, TransactionService transactionService) { this.users=users; this.accounts=accounts; this.transactions=transactions; this.transactionService=transactionService; }
